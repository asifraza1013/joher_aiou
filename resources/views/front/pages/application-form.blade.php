            ...
            @foreach (config('constants.application_cate') as $key=>$item)
                <div class="col-sm-6 col-md-4">
                    <div class="course margin_top wow fadeIn" data-wow-delay="600ms">
                        <h3 class="bottom10"><a href="">{{ $item }}</a></h3>
                        <p class="bottom20">Click to find more detail.</p>
                        <a class="btn_common yellow border_radius"
                            href="{{ route('front.admission.detail', $key) }}">view details</a>
                    </div>
                </div>
            @endforeach
            <div class="col-sm-6 col-md-4">
                <div class="course margin_top wow fadeIn" data-wow-delay="500ms">
                    ...
                    <p class="bottom20">Click to find more detail.</p>
                    <a class="btn_common yellow border_radius"
                        href="{{ route('front.admission.detail', 'roll_slip') }}">view details</a>
                </div>
            </div>
            <div class="col-sm-6 col-md-4">
                <div class="course margin_top wow fadeIn" data-wow-delay="400ms">
                    ...
                    <a class="btn_common yellow border_radius"
                        href="{{ route('front.admission.detail', 'result') }}">view details</a>
                </div>
            </div>
        </div>
    </div>
