...
<div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active"><a href="{{URL::TO('assignment')}}" class="nav-link">Assignments</a></li>
          ...
          <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-darken">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">DOWNLOAD {{$classes->name}} Assignments</h3>
                <p>
                <br> <a class="btn btn-primary" href="{{URL::TO('')}}/alladata/{{$classes->id}}"> Click To Get Assignments</a></p>
              </div>
            </div>      
          </div>
          @endforeach
