...
<div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active"><a href="{{URL::TO('results')}}" class="nav-link">Results</a></li>
        ...
        <div class="row no-gutters">
          <div class="col-md-12 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-primary">
            <div class="media block-6 d-block text-center">
              ...
              <h1 style="color:white;">Compressor</h1>
                @foreach($link as $links)
                @if($links->category == 'Compressor')
                <p>
                 <h3 class="heading"> {{$links->description}}</h3>
              <br>
              @if(!empty($links->link))
