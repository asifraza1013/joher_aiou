...
<div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav mr-auto">
           <li class="nav-item  "><a href="{{URL::TO('index')}}" class="nav-link pl-0">Home</a></li>
            ...
            <li class="nav-item active"><a href="{{URL::TO('videolectures')}}" class="nav-link">Video Lectures</a></li>
          ...
          <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-darken">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">View {{$classes->name}} Lectures</h3>
                <p>
                <br> <a class="btn btn-success" href="{{URL::to('')}}/allvdata/{{$classes->id}}"> Click To View</a></p>
              </div>
            </div>      
          </div>
           @endforeach
