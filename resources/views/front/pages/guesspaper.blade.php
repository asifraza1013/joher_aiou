...
<div class="collapse navbar-collapse" id="ftco-nav">
          <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item active"><a href="{{URL::TO('guesspaper')}}" class="nav-link">Past Papers</a></li>
         ...
         <div class="col-md-3 d-flex services align-self-stretch py-5 px-4 ftco-animate bg-primary">
            <div class="media block-6 d-block text-center">
              ...
              <div class="media-body p-2 mt-3">
                <h3 class="heading">DOWNLOAD {{$classes->name}} Guess Papers</h3>
                <p>
                <br> <a class="btn btn-success" href="{{URL::TO('')}}/allgdata/{{$classes->id}}"> Click To Get Guess Papers</a></p>
              </div>
            </div>      
          </div>
          @endforeach
