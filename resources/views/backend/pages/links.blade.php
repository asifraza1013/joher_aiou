            ...
            <div class="card-body">
              ...
              @foreach($addlink as $addlinks) 
                ...
                <tr>
                  ...
                  <td>{{$addlinks->category}}
                  </td>
                  <td>
                  <a href="" data-toggle="modal" data-target="#addlinks{{$addlinks->id}}" class="btn btn-success">Edit</a>
                <a href="{{URL::to('')}}/deletelink/{{$addlinks->id}}" class="btn btn-danger">Delete</a></td>
                  
                </tr>

<div class="modal fade" id="addlinks{{$addlinks->id}}">
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="{{URL::TO('')}}/editlink" method="POST" >
                 @csrf
                <div class="form-group row">
                  <input type="hidden" name="id" value="{{$addlinks->id}}">
                            <label for="name" class="col-md-4 col-form-label text-md-right">{{ __('Description') }}</label>

                            <div class="col-md-6">
                                <textarea type="text" class="form-control " name="description" value="" required  autofocus>
                ...
                <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select type="text" class="form-control " name="category" value="" required  autofocus>
                                  <option>{{$addlinks->category}}</option>
