        ...
        <div class="row">
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="#" class="small-box-footer" data-toggle="modal" data-target="#books">ADD<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="#" class="small-box-footer" data-toggle="modal" data-target="#assignment" >ADD <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="#" class="small-box-footer" data-toggle="modal" data-target="#thesis" >ADD<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          <div class="col-lg-3 col-6">
        ...
        <div class="row">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="#" class="small-box-footer" data-toggle="modal" data-target="#banner" >ADD <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              ...
              <a href="#" class="small-box-footer" data-toggle="modal" data-target="#notification">ADD<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              ...
              <a href="#" class="small-box-footer" data-toggle="modal" data-target="#link" >ADD <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="#" class="small-box-footer" data-toggle="modal" data-target="#video" >ADD<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          <!-- ./col -->
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="#" class="small-box-footer" data-toggle="modal" data-target="#classes" >ADD<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
           ...
           <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              ...
              <a href="#" class="small-box-footer" data-toggle="modal" data-target="#description" >ADD<i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
          ...
          <!-- lesson plan -->
           <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              ...
              <a href="#" class="small-box-footer" data-toggle="modal" data-target="#lesson" >ADD <i class="fas fa-arrow-circle-right"></i></a>
            </div>
          </div>
            ...
            <div class="modal-body">
             <form action="{{URL::TO('')}}/addassignment" method="POST" enctype="multipart/form-data">
               ...
               <!--  <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="file" class="form-control " name="a1" value="" required  autofocus>
                            </div>
                </div>
                 ...
                 <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="file" class="form-control " name="a2" value="" required  autofocus>
                            </div>
                </div>
                ...
                <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="file" class="form-control " name="a3" value="" required  autofocus>
                            </div>
                </div>
                ...
                <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="file" class="form-control " name="a4" value="" required  autofocus>
                            </div>
                </div> -->
                <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right">Submit</label>
            ...
            <div class="modal-header">
             ...
             <form action="{{URL::TO('')}}/addthesis" method="POST" enctype="multipart/form-data"  id="my-awesome-dropzone">
                ...
                <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="submit" class="form-control btn btn-success " name="" value="" required  autofocus>
                            </div>
                </div>
              </form>
            </div>
                                  ...
                                  <option>Compressor</option>
                                   ...
                                   <option>Table Book</option>
                                    <option>Table Guess</option>
                                     <option>Table Thesis</option>
                                      <option>Table Lectures</option>
                                      <option>Table Lesson</option>
                                </select>
                            </div>
                </div>
            ...
            <div class="modal-body">
              <form action="{{URL::TO('')}}/addclass" method="POST">
                ...
                <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input type="submit" class="form-control btn btn-success " name="pdffile" value="Submit" required  autofocus>
                            </div>
                </div>
              </form>
            </div>
